...
__model_name__ = 'linha_talao_bar.LinhaTalaoBar'
...
class LinhaTalaoBar(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'linha_talao_bar'
        self.__title__ = 'Linhas de Venda de Bar'
        self.__model_name__ = __model_name__
        self.__list_edit_mode__ = 'inline'
        self.__get_options__ = ['produto']

        self.talao_bar = parent_field(view_order=1, name ='Talão', args='style:visibility="hidden"', model_name='talao_bar.TalaoBar', nolabel=True, onlist=False, column='numero')

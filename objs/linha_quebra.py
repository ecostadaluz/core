...
__model_name__ = 'linha_quebra.LinhaQuebra'
...
class LinhaQuebra(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'linha_quebra'
        self.__title__ = 'Linhas de Talão de Quebra'
        self.__model_name__ = __model_name__
        self.__list_edit_mode__ = 'inline'
        self.__get_options__ = ['produto']

        self.quebra = parent_field(view_order=1, name ='Quebra', args='style:visibility="hidden"', model_name='quebra.Quebra', nolabel=True, onlist=False, column='numero')

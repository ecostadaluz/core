...
__model_name__ = 'linha_oferta.LinhaOferta'
...
class LinhaOferta(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'linha_oferta'
        self.__title__ = 'Linhas de Talão de Oferta'
        self.__model_name__ = __model_name__
        self.__list_edit_mode__ = 'inline'
        self.__get_options__ = ['produto']

        self.oferta = parent_field(view_order=1, name ='Oferta', args='style:visibility="hidden"', model_name='oferta.Oferta', nolabel=True, onlist=False, column='numero')

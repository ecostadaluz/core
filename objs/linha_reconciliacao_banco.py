...
__model_name__ = 'linha_reconciliacao_banco.LinhaReconciliacaoBanco'
...
class LinhaReconciliacaoBanco(Model, View):
    def __init__(self, **kargs):
        Model.__init__(self, **kargs)
        self.__name__ = 'linha_reconciliacao_banco'
        self.__title__ = 'Linhas de Reconciliação Bancária'
        self.__model_name__ = __model_name__
        self.__list_edit_mode__ = 'inline'
        self.__order_by__ = 'linha_reconciliacao_banco.metodo'
        self.__auth__ = {
            'read':['All'],
            'write':['All'],
            'create':['All'],
        ...
        self.reconciliacao_banco = parent_field(view_order = 1, name = 'Reconciliacao Banco', model_name = 'reconciliacao_banco.ReconciliacaoBanco', onlist = False, search = False, column = 'numero')
